...
INSERT INTO `account` VALUES (1,'admin','12345',1,'Đang hoạt động',1),(2,'staff1','12345',2,'Đang hoạt động',1),(3,'staff2','12345',3,'Ngừng hoạt động',2);
...
INSERT INTO `function` VALUES ('1','Quản lý sách'),('10','Thống kê'),('2','Quản lý mượn sách'),('3','Quản lý trả sách'),('4','Quản lý nhập sách'),('5','Quản lý nhân viên'),('6','Quản lý thành viên'),('7','Quản lý tài khoản'),('8','Quản lý vi phạm'),('9','Quản lý phân quyền');
...
INSERT INTO `permission` VALUES (1,'Admin'),(2,'Nhân viên thủ thư'),(3,'Nhân viên nhập hàng');
...
INSERT INTO `staff` VALUES (1,'Nguyễn Văn A','a.nguyen@example.com','0123456789','Hà Nội','2023-01-01','Đang làm việc'),(2,'Trần Thị B','b.tran@example.com','0987654321','Hồ Chí Minh','2023-01-15','Đang làm việc'),(3,'Lê Văn C','c.le@example.com','0112233445','Đà Nẵng','2023-02-01','Đã nghỉ việc');
...
-- Dump completed on 2024-10-29 23:53:15
