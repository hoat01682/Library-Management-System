 ...
 * @author hieun
 */
public class ChoosePenalty_Frame extends javax.swing.JFrame {

    /**
     * Creates new form ChooseMember_Frame
     */
    public ChoosePenalty_Frame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        penalty_Table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã vi phạm", "Tên vi phạm", "Tiền phạt"
            }
        ));
        jScrollPane1.setViewportView(penalty_Table);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChoosePenalty_Frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
