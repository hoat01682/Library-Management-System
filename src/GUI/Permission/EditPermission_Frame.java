 ...
 * @author hieun
 */
public class EditPermission_Frame extends javax.swing.JFrame {

    /**
     * Creates new form AddStaff
     */
    public EditPermission_Frame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditPermission_Frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditPermission_Frame().setVisible(true);
            }
        });
    }
