 ...
 * @author hieun
 */
public class ChooseBorrowTicket_Frame extends javax.swing.JFrame {

    /**
     * Creates new form ChooseMember_Frame
     */
    public ChooseBorrowTicket_Frame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        borrowTicket_Table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã phiếu mượn", "Mã thành viên"
            }
        ));
        jScrollPane1.setViewportView(borrowTicket_Table);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChooseBorrowTicket_Frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
