...
-- Dumping data for table library_management.bookitem: ~21 rows (approximately)
...
-- Dumping data for table library_management.borrowticket_details: ~1 rows (approximately)
...
INSERT INTO `member` (`member_id`, `full_name`, `phone`, `email`, `address`, `membership_date`, `status`, `violationCount`) VALUES
	...
	(4, 'ascascas219301293', '', '', '', '2024-11-29', 'Đang hoạt động', 0),
	(5, '', '', '', '', '2024-11-29', 'Đang hoạt động', 0);
...
CREATE TABLE IF NOT EXISTS `penaltyticket_detail` (
  ...
  `penaltyticket_id` int DEFAULT NULL,
  `penalty_id` int DEFAULT NULL,
  `isbn` varchar(50) DEFAULT NULL,
  `fine` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_penaltyticket_id_idx` (`penaltyticket_id`) USING BTREE,
  KEY `fk_penalty_id_idx` (`penalty_id`),
  KEY `fk_isbn_idx` (`isbn`),
  CONSTRAINT `FK_penaltyticket_detail_penalty` FOREIGN KEY (`penalty_id`) REFERENCES `penalty` (`penalty_id`),
  CONSTRAINT `FK_penaltyticket_detail_penaltyticket` FOREIGN KEY (`penaltyticket_id`) REFERENCES `penaltyticket` (`penalty_ticket_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
-- Dumping data for table library_management.publisher: ~4 rows (approximately)
...
-- Dumping data for table library_management.purchaseticket_details: ~2 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `returnticket_details` (
  ...
  `borrow_ticket_id` int NOT NULL,
  `isbn` varchar(255) NOT NULL,
  `status` enum('Đúng hạn','Trễ hạn','Hư hỏng','Mất') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
-- Dumping data for table library_management.returnticket_details: ~2 rows (approximately)
