...
INSERT INTO `borrowticket` (`borrow_ticket_id`, `staff_id`, `member_id`, `borrow_date`, `due_date`, `status`) VALUES
	(1, 1, 1, '2024-11-26', '2024-12-03', 'Chưa trả hết');
...
CREATE TABLE IF NOT EXISTS `returnticket_details` (
  ...
  `borrow_ticket_id` int NOT NULL,
  `isbn` varchar(255) NOT NULL,
  `status` enum('Có sẵn','Đang mượn','Hư hỏng','Mất') DEFAULT NULL,
...
INSERT INTO `returnticket_details` (`return_ticket_details_id`, `return_ticket_id`, `borrow_ticket_id`, `isbn`, `status`) VALUES
	(4, 1, 1, '70898484871', 'Có sẵn');
